...
add_action( 'acf/init', 'caniincasa_register_razze_acf_fields' );
...
add_action( 'acf/init', 'caniincasa_register_strutture_acf_fields' );
...
add_action( 'acf/init', 'caniincasa_register_annunci_4zampe_acf_fields' );
...
add_action( 'acf/init', 'caniincasa_register_annunci_dogsitter_acf_fields' );
