        ...
        <div class="container">
            <div class="auth-form-wrapper">
                ...
                if ( isset( $_GET['registration'] ) && $_GET['registration'] === 'success' ) :
                    ...
                    <div class="auth-notification success">
                        ...
                        <div class="notification-content">
                            ...
                            <p><strong>Controlla la tua email</strong> per confermare il tuo indirizzo e completare la registrazione.</p>
                            <p class="notification-note">⚠️ <strong>Importante:</strong> I tuoi annunci non saranno approvati fino a quando non confermerai la tua email.</p>
                        </div>
                    </div>
                    <?php
                endif;
                ...
                if ( isset( $_GET['verification'] ) && $_GET['verification'] === 'success' ) :
                    ...
                    <div class="auth-notification success">
                        ...
                        <div class="notification-content">
                            ...
                            <p>Il tuo account è ora attivo. Puoi iniziare a pubblicare annunci!</p>
                        </div>
                    </div>
                    <?php
                endif;
                ...
                if ( isset( $_GET['verification'] ) && $_GET['verification'] === 'failed' ) :
                    $error_message = isset( $_GET['message'] ) ? sanitize_text_field( $_GET['message'] ) : 'Verifica fallita.';
                    ?>
