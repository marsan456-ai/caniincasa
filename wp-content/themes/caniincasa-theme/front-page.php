		...
		<div class="container">
			<div class="cta-content">
				...
				<div class="cta-buttons">
					<a href="<?php echo esc_url( caniincasa_registration_url() ); ?>" class="btn btn-primary btn-large">
						<?php esc_html_e( 'Registrati Gratis', 'caniincasa' ); ?>
					</a>
					<a href="<?php echo esc_url( caniincasa_login_url() ); ?>" class="btn btn-secondary btn-large">
