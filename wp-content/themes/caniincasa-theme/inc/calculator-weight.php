<?php
/**
 * Dog Weight Calculator - Calcolatore Peso Ideale
 *
 * Calcola il peso ideale del cane basato su:
 * - Body Condition Score (BCS 1-9)
 * - Razza e standard di peso
 * - Sesso e livello di attività
 *
 ...
 * Register shortcode
 */
add_shortcode( 'dog_weight_calculator', 'caniincasa_dog_weight_calculator_shortcode' );

/**
 * Render Dog Weight Calculator
 */
function caniincasa_dog_weight_calculator_shortcode( $atts ) {
    ...
    foreach ( $breeds as $breed ) {
        ...
        // Only include breeds with weight data
    ...
    <div class="dog-weight-calculator">
        <div class="calculator-container">
            <div class="calculator-header">
                <h2>⚖️ Calcolatore Peso Ideale del Cane</h2>
                <p class="calculator-description">Valuta il peso del tuo cane con il Body Condition Score e ricevi un piano personalizzato</p>
            </div>
            ...
            <div class="calculator-info">
                ...
                <p class="info-note">
                    <strong>⚠️ Importante:</strong> Consulta sempre il veterinario prima di iniziare un programma di perdita o aumento di peso. Queste sono linee guida generali.
                </p>
            </div>
        </div>
    </div>
